...
const Upcoming = () => {
  ...
  const fetchMovies = async () => {
    try {
      const res = await axios.get(
        `https://api.themoviedb.org/3/movie/upcoming?api_key=e35fba9ee4d8e27c290f15962efc8a31&page=${page}`
      );
  ...
  return (
    <div>
      ...
      >
        <MovieList type="upcoming" title="Upcoming"  emoji={Fire} movies={movies} />
      </InfiniteScroll>
    </div>
  );
};
